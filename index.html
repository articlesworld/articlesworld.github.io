...
<head>
    ...
    <script>
        window.addEventListener('load', _ => {
            document.querySelector('#search-icon').addEventListener('click', x => {
            ...
            document.querySelector('.menu-toggle').addEventListener('click', x => {
        ...
        <div class="nav-wrapper">
            ...
            <nav class="navbar">
                ...
                <ul class="nav no-search">
                    ...
                    <span class="fas fa-search" id="search-icon">search now</span>
